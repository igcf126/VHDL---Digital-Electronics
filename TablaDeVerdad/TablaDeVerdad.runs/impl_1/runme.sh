...
HD_PWD='C:/Users/new/Desktop/Proyectos VHDL/TablaDeVerdad/TablaDeVerdad.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TablaDeVerdad.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TablaDeVerdad.tcl -notrace
