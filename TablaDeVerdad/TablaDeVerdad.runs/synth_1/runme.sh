...
HD_PWD='C:/Users/new/Desktop/Proyectos VHDL/TablaDeVerdad/TablaDeVerdad.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TablaDeVerdad.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TablaDeVerdad.tcl
