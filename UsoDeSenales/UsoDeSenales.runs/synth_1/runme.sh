...
HD_PWD='C:/Users/new/Desktop/Proyectos VHDL/UsoDeSenales/UsoDeSenales.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UsoDeSenales.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UsoDeSenales.tcl
