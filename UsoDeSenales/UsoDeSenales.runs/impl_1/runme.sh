...
HD_PWD='C:/Users/new/Desktop/Proyectos VHDL/UsoDeSenales/UsoDeSenales.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UsoDeSenales.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UsoDeSenales.tcl -notrace
