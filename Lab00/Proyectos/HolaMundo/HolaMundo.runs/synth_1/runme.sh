...
HD_PWD='C:/Users/new/Dropbox/Shared DB ATEES/ian/INTEC/Laboratorio de ele digital/Lab0/Proyectos/HolaMundo/HolaMundo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HolaMundo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HolaMundo.tcl
