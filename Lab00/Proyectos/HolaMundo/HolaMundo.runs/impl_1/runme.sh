...
HD_PWD='C:/Users/new/Dropbox/Shared DB ATEES/ian/INTEC/Laboratorio de ele digital/Lab0/Proyectos/HolaMundo/HolaMundo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HolaMundo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HolaMundo.tcl -notrace
